...
class Api::V1::JobsController < ApplicationController
  ...
  def job_params
    params.require(:job).permit(:title, :job_location, :start_time, :start_date ,:end_time, :end_date, :desc, :total_child_count, :infant_count, :toddler_count, :school_age_count, :pay_rate, :non_smoking, :first_aid_cert, :has_pets, :caregiver_id, :id)
  end
